...
To change it to run on Windows or Linux, just compile to the OS you want, put the binaries in the bin folder and configure the path on the DeviceSettings_EOG.json file. Nothing else needs to be done to change things from running on either OS.
