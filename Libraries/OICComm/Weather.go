...
func getAllWeathers() {
	...
	var comms_map map[string]any = Utils.GetFromCommsChannel(false, Utils.NUM_LIB_OICComm, 0, 10)
	if comms_map == nil {
		return
	}
...
/*
GetWeatherLocationsList updates and returns the weather locations list separated by "|".
