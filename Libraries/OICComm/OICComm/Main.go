 ...
 */
func GetNews() string {
	Utils.QueueMessageSERVER(false, Utils.NUM_LIB_OICComm, 0, []byte("JSON|true|News"))
...
func GetWeather() string {
	Utils.QueueMessageSERVER(false, Utils.NUM_LIB_OICComm, 1, []byte("JSON|true|Weather"))
